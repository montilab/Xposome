          ...
          fluidRow(
            column(
              ...
              shinyjs::hidden(
                ...
                actionButton(inputId = "cancel_de_generate", label = "Cancel", icon=icon("fas fa-arrow-circle-right"), class="mybuttons")
              )
            )
          )
        ),
          ...
          fluidRow(
            column(
              ...
              shinyjs::hidden(
                ...
                actionButton(inputId = "cancel_gs_generate", label = "Cancel", icon=icon("fas fa-arrow-circle-right"), class="mybuttons")
              )
            )
          )
        ),
          ...
          fluidRow(
            column(
              ...
              shinyjs::hidden(
                ...
                actionButton(inputId = "cancel_conn_generate", label = "Cancel", icon=icon("fas fa-arrow-circle-right"), class="mybuttons")
              )
            )
          )
        )
