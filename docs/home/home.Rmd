...
<!-- introduction: start -->
<p><div style="float: right; padding: 10px 0 15px 15px;"><img width="100px" height="120px" src="www/shiny.svg"><img width="100px" height="120px" src="www/rmarkdown.svg"><img width="100px" height="120px" src="www/ggplot2.svg"><img width="100px" height="120px" src="www/plumber.svg">
</div>
...
<p>There are two types of Xposome applications that you can install on your local machine:</p>
<ul>
...
<p>The Xposome application requires several structural datasets in order for it to run smoothly. We provide API access to our data, see <a href="#api-calls">API Explorer</a>.</p>
<!-- data access: end -->
